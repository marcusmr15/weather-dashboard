////$(document).foundation(); unnecessary code as this is used when using the Foundations Framework JavaScript link
      ...
      fetch(apiUrl)
        ...
        .then(data => {
          ...
          .then(forecastData => {
            ...
            //* city
            var cityForecasts = forecastData.city.name;
            console.log('City:', cityForecasts);
            //! time 1
